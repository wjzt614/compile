...
string getNodeName(ast_node * astnode)
{
    ...
    switch (astnode->node_type) {
        ...
        case ast_operator_type::AST_OP_FUNC_FORMAL_PARAM_ARRAY:
            nodeName = "formal-param_array";
            break;
        case ast_operator_type::AST_OP_VAR_DECL:
            nodeName = "var-decl";
            break;
        case ast_operator_type::AST_OP_VAR_DEF_INIT:
            nodeName = "var-init";
            break;
        ...
        case ast_operator_type::AST_OP_ARRAY_ACCESS:
            ...
            break;
        case ast_operator_type::AST_OP_ARRAY_INIT_EMPTY:
            nodeName = "Init_list_empty";
            break;
        case ast_operator_type::AST_OP_ARRAY_INIT_LIST:
            nodeName = "Init_list";
            break;
        case ast_operator_type::AST_OP_ARRAY_INIT_ELEM:
            nodeName = "Init_elem";
            break;
